...
if( ! defined( 'HALCYON_THEME_VERSION' ) ) define( 'HALCYON_THEME_VERSION', $theme_data->get( 'Version' ) );
if( ! defined( 'HALCYON_THEME_NAME' ) ) define( 'HALCYON_THEME_NAME', $theme_data->get( 'Name' ) );
...
function halcyon_admin_scripts() {
	wp_enqueue_style( 'halcyon-admin-style',get_template_directory_uri().'/inc/css/admin.css', '',HALCYON_THEME_VERSION );    
}
