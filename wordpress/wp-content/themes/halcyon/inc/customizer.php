...
function halcyon_customize_preview_js() {
	...
	wp_enqueue_script( 'halcyon_customizer', get_template_directory_uri() . '/js' . $build . '/customizer' . $suffix . '.js', array( 'customize-preview' ), HALCYON_THEME_VERSION, true );
}
add_action( 'customize_preview_init', 'halcyon_customize_preview_js' );

function halcyon_customize_script(){
    wp_enqueue_style( 'halcyon-customize', get_template_directory_uri() . '/inc/css/customize.css', array(), HALCYON_THEME_VERSION );
    wp_enqueue_script( 'halcyon-customize', get_template_directory_uri() . '/inc/js/customize.js', array( 'jquery', 'customize-controls' ), HALCYON_THEME_VERSION, true );
}
add_action( 'customize_controls_enqueue_scripts', 'halcyon_customize_script' );